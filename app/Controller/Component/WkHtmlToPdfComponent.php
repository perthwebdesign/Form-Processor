 ...
 */
    ...
    public function createPdf($layout = null)
    {
        ...
        if ($file->write($view, 'w'))
        {
			...
			//.. TODO: Paths and URL's shouldn't be hard coded, or at least not here
            $url = "http://{$_SERVER['HTTP_HOST']}/form-processor/{$controllerName}/getViewDump/{$fileName}";
            $output = TMP."output{$randomNumber}.pdf";
			
            exec("/Users/perthwebdesign/Sites/form-processor/app/Lib/wkhtmltopdf {$url} {$output}");
        }
